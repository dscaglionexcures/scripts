...
<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="bgcolor-td">#FFFFFF</xsl:param>
            ...
            <head>
                ...
                <style type="text/css" media="all">
                    ...
                    #documentheader h1 {
                        ...
                        margin: 0 0 15px 0;
                        padding-bottom: 10px;
                        border-bottom: 2px solid #0254BE;
                    }
                    #documentfooter{
                        margin-bottom: 25px;
                        padding: 20px;
                    ...
                    .section-title .button.expandCollapse {
                        color: #ffffff;
                    }
                    h1, h2, h3 {
                        color: #0254BE;
                    ...
                    .narr_footnote{
                        font-size: <xsl:value-of select="$font-size-footnote"></xsl:value-of>; /* IE8 hack: doesn't understand inheritance */
                        margin-left: 20px;
                        margin-top: 10px;
                        padding-left: 15px;
                        border-left: 2px solid #0254BE;
                    }
                    .td_label{
                        font-size: <xsl:value-of select="$font-size-main"/>; /* IE8 hack: doesn't understand inheritance */
                        font-weight: 600;
    ...
    <xsl:template name="patientInformation">
        <div class="section">
            <div class="section-title">
                <h3 id="patient-information">
                Patient Information
                </h3> 
            </div>
            <div class="header_table">
                <xsl:for-each select="hl7:recordTarget/hl7:patientRole">
                    <div class="cda-field">
                        <div class="cda-label">
                            <span class="cda-label">
                                <xsl:text>Patient Name:</xsl:text>
                            </span>
                            <span class="cda-value">
                                <xsl:choose>
                                    <xsl:when test="hl7:patient/hl7:name[contains(concat(' ', normalize-space(@use), ' '), ' L ')]">
                                        <xsl:call-template name="show-name-simple">
                                            <xsl:with-param name="in" select="hl7:patient/hl7:name[contains(concat(' ', normalize-space(@use), ' '), ' L ')][1]"/>
                                        </xsl:call-template>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:call-template name="show-name-simple">
                        ...
                        <div class="cda-label">
                            <xsl:if test="hl7:patient/hl7:administrativeGenderCode">
                                ...
                                <span class="cda-value">
                                    <xsl:choose>
                                        <xsl:when test="hl7:patient/hl7:administrativeGenderCode/@displayName">
                        ...
                        <div class="cda-label">
                            ...
                            <xsl:if test="hl7:patient/hl7:maritalStatusCode">
                                <span class="cda-value">
                                    <xsl:value-of select="hl7:patient/hl7:maritalStatusCode/@displayName"/>
                                </span>
                            </xsl:if>
                        </div>
                        <div class="cda-label">
                            <xsl:if test="hl7:patient/hl7:raceCode">
                                <span class="cda-label">
                        ...
                        <div class="cda-label">
                            <xsl:if test="hl7:patient/hl7:ethnicGroupCode">
                                <span class="cda-label">
                    ...
                    <div class="cda-field">
                        <div class="cda-label">
                            <xsl:if test="hl7:addr">
                                ...
                                <div class="cda-value">
                                    <xsl:apply-templates select="hl7:addr[1]"/>
                                </div>
                            </xsl:if>
                        </div>
                        <div class="cda-label">
                                    ...
                                    <xsl:for-each select="hl7:telecom">
                                        <div>
                                            <xsl:choose>
                                                ...
                                                ✉️ <xsl:value-of select="substring-after(@value, 'mailto:')"/>
                                                </xsl:when>
                                                <xsl:otherwise>
                                            ...
                                            <xsl:if test="@use">
                                                <span class="badge"><xsl:value-of select="@use"/></span>
                                            </xsl:if>
                                        </div>
                                    </xsl:for-each>
                                </div>
    ...
    <xsl:template name="show-name-simple">
        <xsl:param name="in"/>
        <xsl:if test="$in">
            <xsl:for-each select="$in/hl7:given[string-length(normalize-space(.)) > 0] | $in/hl7:part[@type='GIV'][string-length(normalize-space(@value)) > 0]">
                <xsl:if test="position() > 1">
                    <xsl:text> </xsl:text>
                </xsl:if>
                <xsl:choose>
                    <xsl:when test="self::hl7:given">
            ...
            <xsl:variable name="family">
                <xsl:choose>
                    <xsl:when test="$in/hl7:family[string-length(normalize-space(.)) > 0]">
                        <xsl:value-of select="normalize-space($in/hl7:family[1])"/>
                    </xsl:when>
                    <xsl:when test="$in/hl7:part[@type='FAM'][string-length(normalize-space(@value)) > 0]">
                        <xsl:value-of select="normalize-space($in/hl7:part[@type='FAM'][1]/@value)"/>
                    </xsl:when>
                </xsl:choose>
            </xsl:variable>
            <xsl:if test="string-length(normalize-space($family)) > 0">
                <xsl:if test="$in/hl7:given[string-length(normalize-space(.)) > 0] or $in/hl7:part[@type='GIV'][string-length(normalize-space(@value)) > 0]">
                    <xsl:text> </xsl:text>
                </xsl:if>
                <xsl:call-template name="caseUp">
                    <xsl:with-param name="data" select="normalize-space($family)"/>
                </xsl:call-template>
            </xsl:if>
        </xsl:if>
    </xsl:template>
                        ...
                        <xsl:choose>
                            <xsl:when test="hl7:assignedCustodian/hl7:representedCustodianOrganization/hl7:name">
                                <div class="cda-label">
                                    <span class="cda-label">
                                        <xsl:call-template name="getLocalizedString">
                                            <xsl:with-param name="key" select="representedCustodianOrganization"/>
                                        </xsl:call-template>
                                        Organization:
                                    </span>
                                    <span class="cda-value">
                                        <xsl:value-of select="hl7:assignedCustodian/hl7:representedCustodianOrganization/hl7:name"/>
                                    </span>
                                </div>
                                <div class="cda-label">
                                    <span class="cda-label">
                                    ...
                                    <span class="cda-value">
                                        <div>
                                            <xsl:value-of select="hl7:assignedCustodian/hl7:representedCustodianOrganization/hl7:addr/hl7:streetAddressLine[1]"/>
                                        </div>
                                        <div>
                                            <xsl:value-of select="hl7:assignedCustodian/hl7:representedCustodianOrganization/hl7:addr/hl7:city"/>,
                                            <xsl:value-of select="hl7:assignedCustodian/hl7:representedCustodianOrganization/hl7:addr/hl7:state"/>
                                            <xsl:text> </xsl:text>
                                            <xsl:value-of select="hl7:assignedCustodian/hl7:representedCustodianOrganization/hl7:addr/hl7:postalCode"/>
                                        </div>
                                        <div>
                                            <xsl:value-of select="hl7:assignedCustodian/hl7:representedCustodianOrganization/hl7:addr/hl7:country"/>
                                        </div>
                                    </span>
                                </div>
                            </xsl:when>
        ...
        <xsl:for-each select="hl7:author">
            <div class="section">
                ...
                <div class="section-content">
                    <div class="cda-field">
                        <xsl:choose>
                            <xsl:when test="hl7:assignedAuthor/hl7:assignedAuthoringDevice/hl7:manufacturerModelName">
                                <div class="cda-label">
                                    <span class="cda-label">
                                        <xsl:call-template name="getLocalizedString">
                                            <xsl:with-param name="key" select="manufacturerModelName"/>
                                        </xsl:call-template>
                                        Author:
                                    </span>
                                    <span class="cda-value">
                                        <xsl:value-of select="hl7:assignedAuthor/hl7:assignedAuthoringDevice/hl7:manufacturerModelName"/>
                                    </span>
                                </div>
                            </xsl:when>
                        </xsl:choose>
                        ...
                        <xsl:choose>
                            <xsl:when test="hl7:assignedAuthor/hl7:representedOrganization/hl7:name">
                                <div class="cda-label">
                                    <span class="cda-label">
                                        <xsl:call-template name="getLocalizedString">
                                            <xsl:with-param name="key" select="representedOrganization"/>
                                        </xsl:call-template>
                                        Organization: 
                                    </span>
                                    <span class="cda-value">
    ...
    <xsl:template name="section-title">
        ...
        <xsl:element name="{concat('h', $level)}">
            <xsl:attribute name="id">
                <xsl:if test="ancestor-or-self::hl7:section/hl7:code/@code">
                    <xsl:value-of select="ancestor-or-self::hl7:section/hl7:code/@code"/>
                </xsl:if>
            </xsl:attribute>
    ...
    <xsl:template name="hl7:ClinicalDocument">
        <div class="cda-header">
            ...
            <div class="header-grid">
                <!-- Document Type -->
                <xsl:if test="hl7:code">
                <div class="cda-field-header">
                    <div class="cda-label">Document Type</div>
                    <div class="cda-value">
                    <xsl:value-of select="hl7:code/@displayName"/>
                    </div>
                </div>
    ...
    <xsl:template name="documentHeader">
        <xsl:if test="hl7:code">
            ...
            <div class="cda-field-header">
                <div class="cda-label">Document Date</div>
                <div class="cda-value">
                    <xsl:call-template name="formatDate">
                        <xsl:with-param name="date" select="hl7:effectiveTime/@value"/>
                    </xsl:call-template>
    ...
    <xsl:template match="hl7:addr">
        <div>
            <xsl:if test="hl7:streetAddressLine">
                <xsl:value-of select="hl7:streetAddressLine"/><br/>
            </xsl:if>
            <xsl:if test="hl7:city">
                <xsl:value-of select="hl7:city"/>
                <xsl:if test="hl7:state">, <xsl:value-of select="hl7:state"/></xsl:if>
                <xsl:if test="hl7:postalCode">
                <xsl:text> </xsl:text><xsl:value-of select="hl7:postalCode"/>
                </xsl:if>
            </xsl:if>
            <xsl:if test="hl7:country">
                <br/><xsl:value-of select="hl7:country"/>
            </xsl:if>
        </div>
    </xsl:template>
    ...
    <xsl:variable name="cleanDate">
      <xsl:choose>
        <xsl:when test="contains($date, '-') or contains($date, '+')">
          <xsl:value-of select="substring-before(substring-after(concat($date, '-'), ''), '-')"/>
          <xsl:value-of select="substring-before(substring-after(concat($date, '+'), ''), '+')"/>
        </xsl:when>
        <xsl:otherwise>
    ...
    <xsl:choose>
      <xsl:when test="string-length($cleanDate) >= 8">
        <xsl:variable name="year" select="substring($cleanDate, 1, 4)"/>
        <xsl:variable name="month" select="substring($cleanDate, 5, 2)"/>
        <xsl:variable name="day" select="substring($cleanDate, 7, 2)"/>
        <xsl:value-of select="$month"/>/<xsl:value-of select="$day"/>/<xsl:value-of select="$year"/>
        <xsl:if test="string-length($cleanDate) >= 12">
          <xsl:text> </xsl:text>
          <xsl:value-of select="substring($cleanDate, 9, 2)"/>:<xsl:value-of select="substring($cleanDate, 11, 2)"/>
          <xsl:if test="string-length($cleanDate) >= 14">
            :<xsl:value-of select="substring($cleanDate, 13, 2)"/>
          </xsl:if>
        </xsl:if>
      </xsl:when>
      <xsl:otherwise>
