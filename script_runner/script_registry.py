...
SCRIPT_DEFINITIONS: List[ScriptDefinition] = [
    ...
    ScriptDefinition(
        ...
        file_path="tools/backup_user_permissions.py",
    ...
    ScriptDefinition(
        ...
        file_path="tools/bulk_create_users_from_csv.py",
        safety=SafetyMode.MUTATING,
    ...
    ScriptDefinition(
        ...
        file_path="tools/clinical_concepts_status_docus_count_ALL_subjects.py",
        safety=SafetyMode.READ_ONLY,
        required_env=["XCURES_CLIENT_ID", "XCURES_CLIENT_SECRET"],
    ...
    ScriptDefinition(
        ...
        file_path="tools/download_all_documents.py",
        safety=SafetyMode.READ_ONLY,
    ...
    ScriptDefinition(
        ...
        file_path="tools/evaluate_checklist_to_pdf.py",
        safety=SafetyMode.READ_ONLY,
    ...
    ScriptDefinition(
        ...
        file_path="tools/generate_ccda_pdf.py",
        safety=SafetyMode.READ_ONLY,
        tags=["pdf", "local"],
    ),
    ScriptDefinition(
    ...
    ScriptDefinition(
        ...
        file_path="tools/update_user_email_domains.py",
        safety=SafetyMode.MUTATING,
        required_env=["XCURES_CLIENT_ID", "XCURES_CLIENT_SECRET"],
        mode_behavior=ModeBehavior.DRY_RUN_APPLY_FLAGS,
        default_mode="dry-run",
    ...
    ScriptDefinition(
        ...
        name="Bulk Update User Permissions",
        description='Update all user permissions for a tenant.',
        file_path="tools/update_user_permissions.py",
        safety=SafetyMode.MUTATING,
        env_sets_any=[["XCURES_BEARER_TOKEN"], ["XCURES_CLIENT_ID", "XCURES_CLIENT_SECRET"]],
        ...
        fields=[
            ...
            ScriptField(
                id="exclude_internal_xcures_users",
                label="Exclude Internal xCures Users",
                arg="--exclude-internal-xcures-users",
                type=FieldType.BOOLEAN,
                default=False,
            ),
    ...
    ScriptDefinition(
        ...
        file_path="tools/update_users_new_projects.py",
        safety=SafetyMode.MUTATING,
        required_env=["XCURES_BEARER_TOKEN"],
        mode_behavior=ModeBehavior.DRY_RUN_APPLY_FLAGS,
        default_mode="dry-run",
